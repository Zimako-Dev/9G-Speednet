...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white pt-8">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 -mt-24">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Brand Badge */}
            <div className="inline-flex items-center bg-gradient-to-r from-primary-50 to-accent-blue/10 border border-primary-200 rounded-full px-6 py-3 mb-4">
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              ...
              <div className="flex items-center">
                <CheckCircle className="w-4 h-4 text-accent-green mr-2" />
                <span className="text-gray-700 font-medium text-sm">No Data Caps</span>
              </div>
            </div>
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="relative">
              {/* Speed Visualization */}
              <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-3 mb-3">
                <div className="text-center mb-3">
                  <h3 className="text-base font-bold text-gray-900 mb-1">Connection Speed</h3>
                ...
                {/* Status */}
                <div className="text-center">
                  <div className="inline-flex items-center bg-accent-green/10 text-accent-green px-2 py-1 rounded-full">
                    <div className="w-1 h-1 bg-accent-green rounded-full mr-1.5 animate-pulse"></div>
                    <span className="font-medium text-xs">Optimal</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-gradient-to-br from-primary-500 to-accent-purple p-2.5 rounded-lg text-white">
                  <div className="text-sm font-bold mb-0.5">WiFi 6E</div>
                  <p className="text-xs text-white/80">Latest Tech</p>
                </div>
                <div className="bg-gradient-to-br from-accent-blue to-accent-green p-2.5 rounded-lg text-white">
